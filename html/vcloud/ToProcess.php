...
<body>
	...
	for($count=0;$count<$size;$count++){
		...
		echo "<tr>";
		if($name[0]=="1"){
			echo "<td><a href='manage_requests.php?file=$filename_path'>Criacao VM</td>";
		}
		else if($name[0]=="2"){
			echo "<td><a href='manage_requests.php?file=$filename_path'>Criacao VM sem template</td>";	
		}
		else if($name[0]=="3"){
			echo "<td><a href='manage_requests.php?file=$filename_path'>Remocao VM</td>";	
		}
		else if($name[0]=="4"){
			echo "<td><a href='manage_requests.php?file=$filename_path'>Adicionar disco</td>";	
		}
		else if($name[0]=="5"){
			echo "<td><a href='manage_requests.php?file=$filename_path'>Alterar numero de processadores</td>";	
		}
		else if($name[0]=="6"){
			echo "<td><a href='manage_requests.php?file=$filename_path'>Alterar quantidade de memoria</td>";	
		}
		else if($name[0]=="7"){
			echo "<td><a href='manage_requests.php?file=$filename_path'>Shutdown VM</td>";	
		}
		else if($name[0]=="8"){
			echo "<td><a href='manage_requests.php?file=$filename_path'>Restart VM</td>";	
		}
		else if($name[0]=="a"){
			echo "<td><a href='manage_requests.php?file=$filename_path'>Power ON VM</td>";	
		}
		else if($name[0]=="9"){
			echo "<td><a href='manage_requests.php?file=$filename_path'>Power OFF VM</td>";	
		}
		else if($name[0]=="$1"){
			echo "<td><a href='manage_requests.php?file=$filename_path'>Criar Snapshot</td>";	
		}
		else if($name[0]=="$2"){
			echo "<td><a href='manage_requests.php?file=$filename_path'>Reverter Snapshot</td>";	
		}
		else if($name[0]=="$3"){
			echo "<td><a href='manage_requests.php?file=$filename_path'>Remover Snapshot</td>";	
		}
		else if($name[0]=="b"){
	...
	<input type="radio" name="operation" value="del"> Descartar<br>
  	<input type="radio" name="operation" value="aprov"> Confirmar<br>
