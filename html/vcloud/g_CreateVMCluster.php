...
if($_GET['nome_maquina']!=""){
  ...
  header("Location: requests/request_validation.php?nome_maquina=$vm&quantidade=$quantidade&servidor_host=$host&datastore=$data&template=$template&pasta=$pasta&permission=$permission&core_number=$core&ram=$ram");
}
...
<html lang="en">
  <head>
    ...
    <title>Criar instancias em lote</title>
    <!--tab icon-->
          ...
          <div class="">
            <div class="page-title">
              <div class="title_left">
                <h3>Criar Instâncias em Lote</h3>
              </div>
                    ...
                    <ul class="nav navbar-right panel_toolbox">
                      ...
                      <li class="dropdown">
                        ...
                        <ul class="dropdown-menu" role="menu">
                          ...
                          <li><a href="g_TemplateVMCluster.php">Maquinas de Templates</a>
                          </li>
                        </ul>
                      </li>
