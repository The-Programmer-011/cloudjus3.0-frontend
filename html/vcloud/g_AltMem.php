...
if($name_not_found){
    ...
    $notification .= "new PNotify({ title: 'Máquina ligada', text: 'É preciso desligar a máquina antes de modificar a memória.', type: 'error', styling: 'bootstrap3'});";
  }
?>
...
<html lang="en">
  <head>
    ...
    <title>Alterar memoria RAM</title>
