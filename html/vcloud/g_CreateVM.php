...
if($_SESSION['administrador'][2]=="2" || $_SESSION['administrador'][2]=="3"){
...
if($error){
    $notification .= "new PNotify({ title: 'Máquina já existe', text: 'Não foi possível criar a máquina pois já existe uma máquina este nome.', type: 'error', styling: 'bootstrap3'});";
  }
?>
                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    <form method="get" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
                      ...
                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12">Unidade Responsável</label>
                        <div class="col-md-6 col-sm-6 col-xs-122">
                      ...
                      <?php if(isset($_SESSION['custom'])){ ?>
                        <div class="col-md-2">
                          <p>vCPUs</p>
                          <input name="core_number" class="knob" data-width="100" data-height="120" data-angleOffset=-125 data-angleArc=250 data-fgColor="#26B99A"   data-rotation="clockwise" data-min="2" data-max="16" data-step="2" value="2">
                        </div>
                      <?php }else{ ?>
                        <div class="col-md-2">
                          <p>vCPUs</p>
                      ...
                      <div class="col-md-2">
                        <p>Memória</p>
                        <input name="ram" class="knob" data-width="100" data-height="120" data-angleOffset=-125 data-angleArc=250 data-fgColor="#26B99A"   data-rotation="clockwise" data-min="16384" data-max="98304" data-step="4096" value="16384">
                      </div>
                      ...
                      <div class="form-group">
                        <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                          ...
                          <button type="submit" class="btn btn-success">Solicitar Instância</button>
                        </div>
                      </div>
