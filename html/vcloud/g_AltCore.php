...
if($_GET['nome_maquina']!=""){
  ...
  if(!$error){
    ...
    header("Location: requests/request_validation.php?nome_maquina=$vm&core_number=$core&permission=1");
    echo "deu";
  }
}
if($name_not_found){
    ...
    $notification .= "new PNotify({ title: 'Máquina ligada', text: 'É preciso desligar a máquina antes alterar o número de processadores.', type: 'error', styling: 'bootstrap3'});";
  }
?>
          ...
          <div class="">
            <div class="page-title">
              <div class="title_left">
                <h3>Alterar Npucleos de Processamento</h3>
              </div>
