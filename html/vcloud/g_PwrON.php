...
if($_GET['nome_maquina']!=""){
  ...
  if($name_not_found){
    ...
    $notification .= "new PNotify({ title: 'Máquina ligada', text: 'A máquina já está ligada.', type: 'error', styling: 'bootstrap3'});";
  }
?>
                    ...
                    <form method="get" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
                      ...
                      <div class="form-group">
                        <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                          ...
                          <button type="submit" class="btn btn-success">Ligar máquina</button>
                        </div>
                      </div>
