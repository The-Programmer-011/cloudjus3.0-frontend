                  ...
                  <div class="x_content">
                    <form method="get" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
                      <?php
                        ...
                        echo "<a href='requests/request_validation.php?nome_maquina=$vm'><input type='button' value='Sim' class='btn btn-success'></a> <a href='/g_menu.php'><input type='button' value='Não' class='btn btn-danger'></a>";
                      ?>
                    </form>
                  </div>
                </div>
