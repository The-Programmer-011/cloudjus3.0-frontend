...
$error = 1;
  ...
  if($name_not_found){
    ...
    $notification .= "new PNotify({ title: 'Máquina desligada', text: 'Não é possível reiniciar uma máquina desligada.', type: 'error', styling: 'bootstrap3'});";
  }
?>
          ...
          <div class="">
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Restartar Máquina Virtual</h2>
                  ...
                  <div class="x_content">
                    <form method="get" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
                      ...
                      if($name_not_found){
                        ...
                        echo "* a maquina precisa estar ligada para ser restartada!";
                      }
                      ?>
                      <br>
                      ...
                      <div class="form-group">
                        <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                          ...
                          <button type="submit" class="btn btn-success">Restartar máquina</button>
                        </div>
                      </div>
