...
$error = 1;
  ...
  if($_GET["nome_maquina"]==""){
    ...
    if($file){
      while(!feof($file)){
        ...
        if($search == $word_array[0]){
          ...
          if(strlen($word_array[1]) == 5){ //9 eh para "Running", 5 eh para "off"
            $machine_off = 1;
            $error = 1;
            break;
          }
    ...
    if(!$error){
      ...
      if($_SESSION['administrador'][1]<="3" && $_SESSION['administrador'][1]!="0"){
          ...
          <div class="">
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Forçar desligamento de Máquina Virtual</h2>
                  ...
                  <div class="x_content">
                    <form method="get" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
                      ...
                      if($name_not_found){
                        ...
                        echo "* a maquina já está desligada!";
                      }
                      ?>
                      <br>
                      ...
                      <div class="form-group">
                        <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                          ...
                          <button type="submit" class="btn btn-success">Forçar Desligamento</button>
                        </div>
                      </div>
