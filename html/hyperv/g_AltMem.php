...
$error = 1;
  ...
  if($name_not_found){
    ...
    $notification .= "new PNotify({ title: 'Máquina ligada', text: 'É preciso desligar a máquina antes de aumentar a memória.', type: 'error', styling: 'bootstrap3'});";
  }
?>
