...
if($_GET["nome_maquina"]==""){
  ...
  if(!$error){
    ...
    $ram = $_GET['ram'];
    header("Location: /hyperv/requests/request_validation.php?nome_maquina=$vm&servidor_host=$host&hardDisk=$disk&template=$template&core_number=$core&ram=$ram", true,  301 );
  }
}
if($repeat_name){
