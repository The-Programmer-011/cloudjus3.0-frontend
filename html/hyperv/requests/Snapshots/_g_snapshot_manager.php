                        ...
                        while(!feof($file)){
                          ...
                          while($snap_name == "" && !feof($file)){
                            ...
                            if($no_space=="Name"){
                              ...
                              $snap_name = $line[1];
                              $snap_name = str_replace(' ', '', $snap_name);
                              echo "Snapshot:" . $snap_name . "</td>";
                            }
                          }
                          if($snap_name != ""){
                            echo "<td>";
                            echo "<a href='_g_confirmation.php?nome_maquina=$vm&snap=$snap_name&op=2' target='_blank'><input type='button' value='reverter' class='btn btn-warning'></a> <a href='_g_confirmation.php?nome_maquina=$vm&snap=$snap_name&op=3'   target='blank'><input type='button' value='deletar' class='btn btn-danger'></a>" .  "<br>";
                            echo "</td>";
                            echo "</tr>";
                          }
                        }
