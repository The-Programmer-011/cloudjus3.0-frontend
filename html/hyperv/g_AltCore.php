...
//=============================Validação=============================
  ...
  if($name_not_found){
    ...
    $notification .= "new PNotify({ title: 'Máquina ligada', text: 'É preciso desligar a máquina antes modificar o número de processadores.', type: 'error', styling: 'bootstrap3'});";
  }
?>
          ...
          <div class="">
            <div class="page-title">
              <div class="title_left">
                <h3>Alterar Núcleos de Processamento</h3>
              </div>
