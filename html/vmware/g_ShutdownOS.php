...
if($_GET['nome_maquina']!=""){
    ...
    if(!$error){
      ...
      if($_SESSION['administrador'][0]<="3" && $_SESSION['administrador'][0]!="3"){
        header("Location: g_maintenance.php?nome_maquina=$vm");
      }
      else{
  ...
  if($name_not_found){
    ...
    $notification .= "new PNotify({ title: 'Máquina desligada', text: 'A máquina já está desligada.', type: 'error', styling: 'bootstrap3'});";
  }
          ...
          <div class="">
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Desligar Instância (gracefully) </h2>
                  ...
                  <div class="x_content">
                    ...
                    <p> O processo de shutdown de uma VM é o mais recomendado para realizar um desligamento suave. Contudo, a VM deve estar em funcionamento normal. <br> Caso o shutdown não seja bem-sucedido, deve ser utilizado o processo de Power Off. </p>
                    ...
                    <form method="get" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
                      ...
                      if($name_not_found){
                        ...
                        echo "* a maquina já esta desligada";
                      }
                      ?>
                      <br>
                      ...
                      <div class="form-group">
                        <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                          ...
                          <button type="submit" class="btn btn-success">Desligar VM</button>
                        </div>
                      </div>
