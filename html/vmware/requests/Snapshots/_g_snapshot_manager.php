          ...
          <div class="">
            <div class="page-title">
              <div class="title_left">
                <h3>Gerenciar Snapshots de uma VM</h3>
              </div>
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Snapshots da instância <?php echo $_GET['nome_maquina']; ?></h2>
                  ...
                  <div class="x_content">
                    <form method="get" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
                      ...
                      if($origin == "g_CreateSnap.php"){
                        ...
                        fclose($file);
                        if($status_num == 1){
                          echo "<h1 style='color:#00cc44'>Solicitação de snapshot registrada! </h1>";
                          echo "<p>Nome: $snap_name</p>";
                          echo "<p>Assim que o snapshot for realizado você será notificado por e-mail.</p>";
                        }
                        else if($status_num == 2){
                          echo "<h1 style='color:#ff9900'>Servidores ocupados, seu snapshot será executado em breve.</h1>";
                          echo "<p>Nome: $snap_name</p>";
                        }
                        else if($status_num == 0){
                          echo "<h1 style='color:#ff3300'>Servidores OFFLINE</h1>";
                          echo "<p>Seu pedido será registrado e executado assim que for possível.</p>";
                          echo "<p>Nome: $snap_name</p>";
                        }
                      }
                      ...
                      if(!$file){
                        echo "<h1>Nao há snapshots a mostrar.</h1>";
                      }
                      else{
                        $count=0;
                        fgets($file) . "<br>";
